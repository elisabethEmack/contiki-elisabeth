...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/1_randomness/15_ch/2-node_multiple_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>55.74537614806378</x>
        <y>53.071041717127756</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>46.42948502013897</x>
        <y>79.43956358890541</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>33.829902452924856</x>
        <y>64.28117012469929</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.33010605461126 0.0 0.0 6.33010605461126 17.4894932921957 -209.88374332683088</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("15_ch_3_sf_log_" + id +".txt");
 	}
 	//Write to file.
