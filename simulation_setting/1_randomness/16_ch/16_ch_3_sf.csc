...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype449</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/1_randomness/16_ch/2-node_multiple_sf.c</source>
      <commands>make 2-node_multiple_sf.cooja TARGET=cooja</commands>
    ...
    <mote>
      <interface_config>
        ...
        <x>24.244140527283975</x>
        <y>72.89354971001394</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype449</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>42.99906251956647</x>
        <y>40.115754217758564</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>20.207750511391893</x>
        <y>47.38338861388058</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.596296816842798 0.0 0.0 9.596296816842798 -85.77566934588184 -369.2354117778518</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>16 channel multiple sf</notes>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("3_sf_log_" + id +".txt");
 	}
 	//Write to file.
