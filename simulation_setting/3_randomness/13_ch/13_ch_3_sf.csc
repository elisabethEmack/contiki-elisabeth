...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype824</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/13_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>33.39183151447153</x>
        <y>2.3088078147762925</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype824</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>68.0929147589844</x>
        <y>0.19880457825282027</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.24878792536683</x>
        <y>17.965533497688014</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.689224664972158 0.0 0.0 3.689224664972158 6.799985464762543 14.993837973673081</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("13_3_node_" + id +".txt");
 	}
 	//Write to file.
