...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/13_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>70.7061710074122</x>
        <y>91.71277985707412</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>79.37754207128553</x>
        <y>94.3695836752823</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>84.14323121743845</x>
        <y>82.26363754016955</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.322963417410057 0.0 0.0 6.322963417410057 -241.46793374560275 -266.4226980223001</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("13_log_" + id +".txt");
