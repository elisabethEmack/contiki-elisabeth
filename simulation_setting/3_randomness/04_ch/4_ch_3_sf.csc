...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/04_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>63.123167628342614</x>
        <y>86.34950660668326</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>72.90338615223936</x>
        <y>86.03654235259728</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>69.16491229172622</x>
        <y>82.03495227127144</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>27.22725850562867 0.0 0.0 27.22725850562867 -1637.171183914327 -2092.086670172236</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("04_3_node_" + id +".txt");
 	}
 	//Write to file.
