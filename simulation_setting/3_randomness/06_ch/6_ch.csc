...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype546</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/06_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>24.172526053138878</x>
        <y>61.046739620763844</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype546</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.199476275594165</x>
        <y>60.64091806864563</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>38.48623375030839</x>
        <y>75.83924766628307</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.115834319515693 0.0 0.0 9.115834319515693 -158.65517709895641 -537.0652893698265</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("06_log_" + id +".txt");
