...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/10_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>33.762345367821936</x>
        <y>48.15281473760309</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>10.724532790770647</x>
        <y>78.47486866330662</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>38.29599137953905</x>
        <y>74.90390548605097</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.016010700731622 0.0 0.0 4.016010700731622 -25.433474811718426 -106.098552607566</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("10_3_node_" + id +".txt");
 	}
 	//Write to file.
