...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/09_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>15.77911446083997</x>
        <y>14.603588839854552</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.95254538628204</x>
        <y>13.067329291518256</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>32.359180403508745</x>
        <y>28.283313865196142</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.919590858322359 0.0 0.0 6.919590858322359 -91.54865253928672 5.935233813524517</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("09_3_node_" + id +".txt");
 	}
 	//Write to file.
