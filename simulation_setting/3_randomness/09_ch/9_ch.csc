...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/09_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>13.662289016519699</x>
        <y>40.65253228321891</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>42.37642479836365</x>
        <y>40.295409469195604</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>28.824794586766025</x>
        <y>30.01936659626138</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.466759956888337 0.0 0.0 4.466759956888337 -43.389801862061844 66.66279600393784</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("09_log_" + id +".txt");
