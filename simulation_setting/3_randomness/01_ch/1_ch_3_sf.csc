...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/01_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>91.90731694133474</x>
        <y>59.94189881593374</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>71.3906515899296</x>
        <y>59.41323084233899</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>80.23143616747764</x>
        <y>45.771099278594995</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.264709501754264 0.0 0.0 4.264709501754264 -192.70096805630558 -19.862058160777973</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("01_3_node_" + id +".txt");
 	}
 	//Write to file.
