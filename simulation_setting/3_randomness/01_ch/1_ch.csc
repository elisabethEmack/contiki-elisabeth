...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype521</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/01_ch/2-node.c</source>
      <commands>make 2-node.cooja TARGET=cooja</commands>
    ...
    <mote>
      <interface_config>
        ...
        <x>10.34270145325938</x>
        <y>68.16006676019148</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype521</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>8.92655151571165</x>
        <y>92.21126895159638</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>20.97748930453037</x>
        <y>80.95950925264876</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.736476451011602 0.0 0.0 5.736476451011602 34.22808702229599 -198.69504558600275</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("01_log_" + id +".txt");
        outputs[id.toString()].write("col\n");
 	}
 	//Write to file.
