...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/12_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>80.18682735617737</x>
        <y>68.05654361361027</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.89649293290651</x>
        <y>49.94148188457242</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>55.40422532353789</x>
        <y>73.9374704389202</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.557417762101062 0.0 0.0 5.557417762101062 -75.26806227211516 -168.2235449965243</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("12_3_node_" + id +".txt");
 	}
 	//Write to file.
