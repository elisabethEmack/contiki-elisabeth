...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/15_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>19.267669021664467</x>
        <y>85.98053255940997</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>51.78353969248645</x>
        <y>85.84151163820749</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>36.85811721122054</x>
        <y>74.74065738323795</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.963162744003479 0.0 0.0 3.963162744003479 -18.717812488036632 -12.482116076304381</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>15 channel 3 randomness</notes>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("15_log_" + id +".txt");
