...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/15_ch/2-node_multiple_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>41.65545976236457</x>
        <y>34.18275151304146</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>59.00134143328942</x>
        <y>27.18894339499347</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>10.39735671983573 0.0 0.0 10.39735671983573 -349.78233415440116 -101.96587058589593</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("15_3_node_" + id +".txt");
 	}
 	//Write to file.
