...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype184</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/11_ch/2-node_3_sf.c</source>
      <commands>make 2-node_3_sf.cooja TARGET=cooja</commands>
    ...
    <mote>
      <interface_config>
        ...
        <x>55.208540856071515</x>
        <y>49.66550984435825</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype184</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>76.32637995860146</x>
        <y>49.438509240092706</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>66.48444723228138</x>
        <y>63.639636431768004</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>15.248469478704026 0.0 0.0 15.248469478704026 -808.8531127131458 -738.1343264929079</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("11_3_node_" + id +".txt");
 	}
 	//Write to file.
