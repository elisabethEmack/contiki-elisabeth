...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/11_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>69.76065442801084</x>
        <y>91.7112635280782</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>73.07939371036608</x>
        <y>70.38590806839927</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>60.25379325775283</x>
        <y>80.51924634237574</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>6.124495111839147 0.0 0.0 6.124495111839147 -155.29922591608965 -231.41245790557954</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("11_log_" + id +".txt");
