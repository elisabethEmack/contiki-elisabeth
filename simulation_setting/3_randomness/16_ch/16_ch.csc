...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/16_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>49.93677545289737</x>
        <y>50.813030867726496</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <interface_config>
        ...
        <history>log mac 4~;help~;</history>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>70.0298970319255</x>
        <y>50.100954654229504</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>61.20531977630158</x>
        <y>59.71601691354898</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.601284035818908 0.0 0.0 9.601284035818908 -302.0132960390319 -349.6919679878453</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
load("nashorn:mozilla_compat.js");
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("16_log_" + id +".txt");
