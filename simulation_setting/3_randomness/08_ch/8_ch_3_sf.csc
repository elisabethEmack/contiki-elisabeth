...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype455</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/08_ch/2-node_3_sf.c</source>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype683</identifier>
    ...
    <mote>
      <interface_config>
        ...
        <x>37.07950148726117</x>
        <y>48.55019026008765</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype455</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>37.14271968601243</x>
        <y>85.08513807396744</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>64.16335974014216</x>
        <y>61.609830953626656</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype683</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.86058571290848 0.0 0.0 5.86058571290848 -199.6712330216479 -218.59064798719854</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("08_3_node_" + id +".txt");
 	}
 	//Write to file.
