...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/03_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>37.10586713561164</x>
        <y>83.75288542655545</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>36.87401035721574</x>
        <y>97.96571734163263</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>46.16442542782104</x>
        <y>92.47934297834522</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>17.1687559594482 0.0 0.0 17.1687559594482 -539.0313586638035 -1366.3325920780458</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("03_3_node_" + id +".txt");
 	}
 	//Write to file.
