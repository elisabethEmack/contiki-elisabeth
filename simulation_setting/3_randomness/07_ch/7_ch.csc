...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype165</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/07_ch/2-node.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>72.91180129178915</x>
        <y>59.34697702243517</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype165</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>64.04559729479426</x>
        <y>72.9110408597125</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>60.77609791057231</x>
        <y>63.090156112322525</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>10.11290972365271 0.0 0.0 10.11290972365271 -403.98682788913226 -520.7566975357025</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
...
TIMEOUT(10800000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("07_log_" + id +".txt");
