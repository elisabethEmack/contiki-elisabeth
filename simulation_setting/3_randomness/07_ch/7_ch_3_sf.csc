...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/simulation_setting/3_randomness/07_ch/2-node_3_sf.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>67.66575119652862</x>
        <y>5.503188169963907</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>35.0983329870098</x>
        <y>4.980074592804796</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>52.883838987168865</x>
        <y>18.994703649692106</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>7.287776520487037 0.0 0.0 7.287776520487037 -122.76923644754254 28.138587020223788</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
...
TIMEOUT(14400000);
 ...
 while (true) {
 	...
 	if(! outputs[id.toString()]){
 		...
 		outputs[id.toString()]= new FileWriter("07_3_node_" + id +".txt");
 	}
 	//Write to file.
